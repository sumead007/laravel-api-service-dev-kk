...
<head>
    ...
    <!-- bootstrap css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('caraft-master/css/bootstrap.min.css') }}">
    <!-- style css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('caraft-master/css/style.css') }}">
    <!-- Responsive-->
    <link rel="stylesheet" href="{{ asset('caraft-master/css/responsive.css') }}">
    <!-- fevicon -->
    <link rel="icon" href="{{ asset('caraft-master/images/fevicon.png') }}" type="image/gif" />

    <!-- Scrollbar Custom CSS -->
    <link rel="stylesheet" href="{{ asset('caraft-master/css/jquery.mCustomScrollbar.min.css') }}">
    <!-- Tweaks for older IEs-->
    <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">
    <!-- owl stylesheets -->
    <link rel="stylesheet" href="{{ asset('caraft-master/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('caraft-master/css/owl.theme.default.min.css') }}">
...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-dark bg-dark">
                <a class="logo" href="index.html"><img
                        src="{{ asset('caraft-master/images/logo.png') }}"></a>
    ...
    auth()->guard('customer')->check())
                        ...
                        @endif
                        <li><a href="#"><img src="{{ asset('caraft-master/images/shopping-bag.png') }}"></a></li>
                        <li><a href="#"><img src="{{ asset('caraft-master/images/search-icon.png') }}"></a></li>
                    </ul>
                </div>
        ...
        <div class="banner_section layout_padding">
            <div id="my_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="taital_main">
                                        <h4 class="banner_taital"><span class="font_size_90">50%</span> Discount
                                            Online Shop</h4>
                                ...
                                <div class="col-md-6">
                                    <div><img src="{{ asset('caraft-master/images/img-1.png') }}"
                                            class="image_1"></div>
                                </div>
                            </div>
                ...
                <a class="carousel-control-prev" href="#my_slider" role="button" data-slide="prev">
                    <i class=""><img src="{{ asset('caraft-master/images/left-icon.png') }}"></i>
                </a>
                <a class="carousel-control-next" href="#my_slider" role="button" data-slide="next">
                    <i class=""><img src="{{ asset('caraft-master/images/right-icon.png') }}"></i>
                </a>
            </div>
        </div>
        <!--banner section end -->
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <div class="beds_section active">
                        ...
                        <div><img src="{{ asset('caraft-master/images/img-2.png') }}" class="image_2"></div>
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="beds_section">
                        ...
                        <div><img src="{{ asset('caraft-master/images/img-3.png') }}" class="image_2"></div>
                        <div class="seemore_bt"><a href="#">see More</a></div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <div class="beds_section">
                        ...
                        <div><img src="{{ asset('caraft-master/images/img-4.png') }}" class="image_2"></div>
                        <div class="seemore_bt"><a href="#">see More</a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <div class="beauty_box">
                        ...
                        <div><img src="{{ asset('caraft-master/images/img-5.png') }}" class="image_3"></div>
                        <div class="seemore_bt"><a href="#">see More</a></div>
                    </div>
                </div>
                <div class="col-lg-8 col-sm-12">
                    <div class="beauty_box_1">
                        ...
                        <div><img src="{{ asset('caraft-master/images/img-6.png') }}" class="image_3"></div>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="feature_box">
                            ...
                            <div><img src="{{ asset('caraft-master/images/img-7.png') }}" class="image_7">
                            </div>
                        </div>
                    ...
                    <div class="col-sm-7">
                        <div class="feature_box_2">
                            <h1 class="readable_text">Readable content of</h1>
                            <div><img src="{{ asset('caraft-master/images/img-8.png') }}" class="image_8">
                            </div>
                            <div class="seemore_bt"><a href="#">see More</a></div>
                        </div>
                    </div>
                ...
                <div class="carousel-item active">
                    <div class="container">
                        ...
                        <div class="client_section_2">
                            <div class="image_9"><img src="{{ asset('caraft-master/images/img-9.png') }}">
                            </div>
                            <h3 class="nolmal_text">Normal distribution</h3>
                            <p class="ipsum_text">It is a long established fact that a reader will be distracted by
                            ...
                            <div class="image_9"><img src="{{ asset('caraft-master/images/icon-10.png') }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="information_main">
                        ...
                        <p class="many_text">Contrary to popular belief, Lorem Ipsum is not simply random text. It
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="information_main">
                        ...
                        <div class="social_icon">
                            <ul>
                                <li><a href="#"><img src="{{ asset('caraft-master/images/fb-icon.png') }}"></a></li>
                                <li><a href="#"><img src="{{ asset('caraft-master/images/twitter-icon.png') }}"></a>
                                </li>
                                <li><a href="#"><img src="{{ asset('caraft-master/images/linkedin-icon.png') }}"></a>
                                </li>
                                <li><a href="#"><img
                                            src="{{ asset('caraft-master/images/instagram-icon.png') }}"></a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <!-- footer section end -->
    <!-- Javascript files-->
    <script src="{{ asset('caraft-master/js/jquery.min.js') }}"></script>
    <script src="{{ asset('caraft-master/js/popper.min.js') }}"></script>
    <script src="{{ asset('caraft-master/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('caraft-master/js/jquery-3.0.0.min.js') }}"></script>
    <script src="{{ asset('caraft-master/js/plugin.js') }}"></script>
    <!-- sidebar -->
    <script src="{{ asset('caraft-master/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
    <script src="{{ asset('caraft-master/js/custom.js') }}"></script>
    <!-- javascript -->
    <script src="{{ asset('caraft-master/js/owl.carousel.js') }}"></script>
    ...
    <script src="{{ asset('caraft-master/js/popper.min.js') }}"></script>
    <script src="{{ asset('caraft-master/js/bootstrap.min.js') }}"></script>
</body>
